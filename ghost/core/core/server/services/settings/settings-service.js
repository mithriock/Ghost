...
module.exports = {
    ...
    getCalculatedFields() {
        ...
        fields.push(new CalculatedField({key: 'donations_enabled', type: 'boolean', group: 'donations', fn: settingsHelpers.areDonationsEnabled.bind(settingsHelpers), dependents: ['stripe_secret_key', 'stripe_publishable_key', 'stripe_connect_secret_key', 'stripe_connect_publishable_key', 'mercadopago_access_token', 'mercadopago_public_key']}));
        fields.push(new CalculatedField({key: 'stripe_enabled', type: 'boolean', group: 'members', fn: settingsHelpers.isStripeConnected.bind(settingsHelpers), dependents: ['stripe_secret_key', 'stripe_publishable_key', 'stripe_connect_secret_key', 'stripe_connect_publishable_key']}));
        fields.push(new CalculatedField({key: 'mercadopago_enabled', type: 'boolean', group: 'members', fn: settingsHelpers.isMercadoPagoConnected.bind(settingsHelpers), dependents: ['mercadopago_access_token', 'mercadopago_public_key']}));
